...
import { BASIC_MATERIAL, RAW_MATERIALS } from "./materials";
import { type BaseStats, EmptyBaseStats } from "./stats";
...
export const FORGE_RECIPES_DATA: {
	...
	[FORGE_RECIPE.WOOD_PLANK]: {
		...
		materialsTypes: toFixedArray(10, [RESOURCE_TYPE.RAW, RESOURCE_TYPE.RAW]),
	...
	[FORGE_RECIPE.HARDENED_LEATHER]: {
		...
		materials: toFixedArray(10, [RAW_MATERIALS.LEATHER, RAW_MATERIALS.GOLD]),
		materialsTypes: toFixedArray(10, [RESOURCE_TYPE.RAW, RESOURCE_TYPE.RAW]),
